...
class MockGeocodingService extends _i1.Mock implements _i3.GeocodingService {
  ...
  @override
  _i4.Future<String> reverseGeocode(dynamic location) =>
      (super.noSuchMethod(
...
///
/// See the documentation for Mockito's code generation for more information.
class MockMapProvider extends _i1.Mock implements _i6.MapProvider {
  MockMapProvider() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i2.Widget buildMap({
    required _i2.ValueChanged<_i7.LatLng>? onLocationChanged,
    _i7.LatLng? initialLocation,
...
///
/// See the documentation for Mockito's code generation for more information.
class MyMockGeocodingService extends _i1.Mock implements _i3.GeocodingService {
  MyMockGeocodingService() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MyMockMapProvider extends _i1.Mock implements _i6.MapProvider {
  MyMockMapProvider() {
    _i1.throwOnMissingStub(this);
  }
